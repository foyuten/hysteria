...
func (o *fakePluggableOutbound) CheckUDP(reqAddr *outbounds.AddrEx) error {
	o.mutex.Lock()
	defer o.mutex.Unlock()
	return o.errHosts[reqAddr.Host]
}
...
func (o *helperTestOutbound) CheckUDP(reqAddr *outbounds.AddrEx) error {
	return nil
}
