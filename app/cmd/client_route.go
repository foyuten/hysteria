...
func (o *clientACLRejectOutbound) CheckUDP(_ *outbounds.AddrEx) error {
	return errClientACLRejected
}
...
func (o *clientACLDebugOutbound) CheckUDP(reqAddr *outbounds.AddrEx) error {
	err := o.Outbound.CheckUDP(reqAddr)
	logClientACLDecision("udp", o.Strategy, reqAddr, err)
	return err
}
...
func (o *clientProxyOutbound) CheckUDP(_ *outbounds.AddrEx) error {
	return nil
}
